...
jbyteArray Java_tgio_rncryptor_RNCryptorNative_generateKey(JNIEnv *env, jobject instance, const jstring salt_, const jstring password_) {
    ...
    env->SetByteArrayRegion (array, 0, 1024, (jbyte *)(buf));
    return array;
    /*char array[1024];
